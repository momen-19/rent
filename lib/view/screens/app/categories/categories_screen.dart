                            ...
                            child: ListTile(
                              ...
                              trailing: Row(
                                ...
                                children: [
                                  IconButton(
                                    onPressed: () {
                                      Navigator.push(context, MaterialPageRoute(builder: (context) => UpdateCatScreen(category:getCategory(snapshot.data!.docs[index])),));
                                    },
                                    icon: Icon(
                                      Icons.edit_outlined,
                                  ...
                                  IconButton(
                                    onPressed: () async{
                                      await deleteCat(path: snapshot.data!.docs[index].id);
                                    },
                                    icon: Icon(
      ...
      floatingActionButton: Padding(
        ...
        child: Row(
          children: [
            ...
            SizedBox(width: 5.w),
            const Text('اضافة فئة جديدة',style: TextStyle(fontSize: 16,color: Colors.white,fontWeight: FontWeight.bold),)
          ],
        ),
      ),
    );
